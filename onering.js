;(() => {
  var Ee = [
    ...
    { name: "oiwa", url: "https://oiwa.neocities.org/", description: "tramontane" },
    {
      name: "suboptimalism",
  ...
  var ue = globalThis,
    Y = ue.trustedTypes,
    Pe = Y ? Y.createPolicy("lit-html", { createHTML: (t) => t }) : void 0,
    pe = "$lit$",
    ...
    z = document,
    D = () => z.createComment(""),
    H = (t) => t === null || (typeof t != "object" && typeof t != "function"),
    Re = Array.isArray,
    Ie = (t) => Re(t) || typeof t?.[Symbol.iterator] == "function",
    de = `[ 	
\f\r]`,
    N = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,
    ze = /-->/g,
...
\f\r"'\`<>=]|("|')|))|$)`,
  ...
  var De = (t, e) => {
      ...
      for (let a = 0; a < s; a++) {
        let n = t[a],
          ...
          h = -1,
          w = 0
        for (; w < n.length && ((i.lastIndex = w), (m = i.exec(n)), m !== null); )
          (w = i.lastIndex),
            i === N
              ? m[1] === "!--"
                ? (i = ze)
                ...
                ? (i = ke)
                : m[2] !== void 0
                ? (Ue.test(m[2]) && (r = RegExp("</" + m[2], "g")), (i = E))
                : m[3] !== void 0 && (i = E)
              : i === E
              ? m[0] === ">"
                ? ((i = r ?? N), (h = -1))
                : m[1] === void 0
                ? (h = -2)
                : ((h = i.lastIndex - m[2].length),
                  (d = m[1]),
                  (i = m[3] === void 0 ? E : m[3] === '"' ? Te : Le))
              : i === Te || i === Le
              ? (i = E)
              : i === ze || i === ke
              ? (i = N)
              : ((i = E), (r = void 0))
        let A = i === E && t[a + 1].startsWith("/>") ? " " : ""
        l +=
          i === N
            ? n + St
            : h >= 0
            ? (o.push(d), n.slice(0, h) + pe + n.slice(h) + _ + A)
            : n + _ + (h === -2 ? a : A)
      }
      return [Ne(t, l + (t[s] || "<?>") + (e === 2 ? "</svg>" : "")), o]
    },
    B = class t {
      constructor({ strings: e, _$litType$: s }, o) {
        ...
        let l = 0,
          ...
          n = this.parts,
          [d, m] = De(e, s)
        if (((this.el = t.createElement(d, o)), (P.currentNode = this.el.content), s === 2)) {
          let h = this.el.content.firstChild
          h.replaceWith(...h.childNodes)
        }
        for (; (r = P.nextNode()) !== null && n.length < a; ) {
          if (r.nodeType === 1) {
            if (r.hasAttributes())
              for (let h of r.getAttributeNames())
                if (h.endsWith(pe)) {
                  let w = m[i++],
                    A = r.getAttribute(h).split(_),
                    J = /([.?@])?(.*)/.exec(w)
                  n.push({
                    type: 1,
                    index: l,
                    name: J[2],
                    strings: A,
                    ctor: J[1] === "." ? X : J[1] === "?" ? ee : J[1] === "@" ? te : L,
                  }),
                    r.removeAttribute(h)
                } else h.startsWith(_) && (n.push({ type: 6, index: l }), r.removeAttribute(h))
            if (Ue.test(r.tagName)) {
              let h = r.textContent.split(_),
                w = h.length - 1
              if (w > 0) {
                r.textContent = Y ? Y.emptyScript : ""
                for (let A = 0; A < w; A++)
                  r.append(h[A], D()), P.nextNode(), n.push({ type: 2, index: ++l })
                r.append(h[w], D())
              }
            }
          } else if (r.nodeType === 8)
            if (r.data === me) n.push({ type: 2, index: l })
            else {
              let h = -1
              for (; (h = r.data.indexOf(_, h + 1)) !== -1; )
                n.push({ type: 7, index: l }), (h += _.length - 1)
            }
          l++
        }
      }
      static createElement(e, s) {
        let o = z.createElement("template")
        return (o.innerHTML = e), o
      }
    }
  function k(t, e, s = t, o) {
    if (e === $) return e
    ...
    return (
      r?.constructor !== l &&
        (r?._$AO?.(!1),
        l === void 0 ? (r = void 0) : ((r = new l(t)), r._$AT(t, s, o)),
        o !== void 0 ? ((s._$Co ??= [])[o] = r) : (s._$Cl = r)),
      r !== void 0 && (e = k(t, r._$AS(t, e.values), r, o)),
      e
    )
  }
  var Q = class {
      ...
      u(e) {
        let {
          ...
          r = (e?.creationScope ?? z).importNode(s, !0)
        P.currentNode = r
        let l = P.nextNode(),
          i = 0,
          a = 0,
        ...
        for (; n !== void 0; ) {
          if (i === n.index) {
            let d
            n.type === 2
              ? (d = new R(l, l.nextSibling, this, e))
              : n.type === 1
              ? (d = new n.ctor(l, n.name, n.strings, this, e))
              : n.type === 6 && (d = new se(l, this, e)),
              this._$AV.push(d),
              (n = o[++a])
          }
          i !== n?.index && ((l = P.nextNode()), i++)
        }
      ...
      p(e) {
        ...
        for (let o of this._$AV)
          o !== void 0 &&
            (o.strings !== void 0 ? (o._$AI(e, o, s), (s += o.strings.length - 2)) : o._$AI(e[s])),
            s++
      }
    },
    R = class t {
      ...
      $(e) {
        let { values: s, _$litType$: o } = e,
          r =
            typeof o == "number"
              ? this._$AC(e)
              : (o.el === void 0 && (o.el = B.createElement(Ne(o.h, o.h[0]), this.options)), o)
        if (this._$AH?._$AD === r) this._$AH.p(s)
        else {
          let l = new Q(r, this),
            i = l.u(this.options)
          l.p(s), this.T(i), (this._$AH = l)
        }
      }
      _$AC(e) {
        let s = Me.get(e.strings)
        return s === void 0 && Me.set(e.strings, (s = new B(e))), s
      }
      k(e) {
        ...
        for (let l of e)
          r === s.length
            ? s.push((o = new t(this.S(D()), this.S(D()), this, this.options)))
            : (o = s[r]),
            o._$AI(l),
            r++
    ...
    L = class {
      ...
      _$AI(e, s = this, o, r) {
        let l = this.strings,
          i = !1
        if (l === void 0)
          (e = k(this, e, s, 0)), (i = !H(e) || (e !== this._$AH && e !== $)), i && (this._$AH = e)
        else {
          let a = e,
            n,
            d
    ...
    te = class extends L {
      constructor(e, s, o, r, l) {
        super(e, s, o, r, l), (this.type = 5)
      }
      _$AI(e, s = this) {
        if ((e = k(this, e, s, 0) ?? g) === $) return
        let o = this._$AH,
          r =
            (e === g && o !== g) ||
            e.capture !== o.capture ||
    ...
    At = ue.litHtmlPolyfillSupport
  At?.(B, R), (ue.litHtmlVersions ??= []).push("3.1.2")
  var j = (t, e, s) => {
    let o = s?.renderBefore ?? e,
      r = o._$litPart$
    if (r === void 0) {
      let l = s?.renderBefore ?? null
      o._$litPart$ = r = new R(e.insertBefore(D(), l), l, void 0, s ?? {})
    }
    return r._$AI(t), r
  }
  function ge(t, e, s) {
    let o = (r) => (Object.is(r, -0) ? 0 : r)
    return t < e ? o(e) : t > s ? o(s) : o(t)
  }
  var Be = class {
    constructor(t, e) {
      ;(this.timerId = 0),
  ...
  var oe = globalThis,
    ...
    q = class {
      ...
      get styleSheet() {
        let e = this.o,
          s = this.t
        if (re && e === void 0) {
          let o = s !== void 0 && s.length === 1
          o && (e = je.get(s)),
            e === void 0 &&
              ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), o && je.set(s, e))
        }
        return e
      }
      toString() {
    ...
    qe = (t) => new q(typeof t == "string" ? t : t + "", void 0, fe),
    v = (t, ...e) => {
      let s =
        t.length === 1
          ? t[0]
    ...
    le = re
      ...
      : (t) =>
          t instanceof CSSStyleSheet
            ? ((e) => {
                let s = ""
                for (let o of e.cssRules) s += o.cssText
                return qe(s)
              })(t)
            : t
  var {
    ...
    ie = globalThis,
    Ve = ie.trustedTypes,
    Tt = Ve ? Ve.emptyScript : "",
    Mt = ie.reactiveElementPolyfillSupport,
    V = (t, e) => t,
    F = {
      toAttribute(t, e) {
        switch (e) {
    ...
    ne = (t, e) => !Ct(t, e),
    Fe = { attribute: !0, type: String, converter: F, reflect: !1, hasChanged: ne }
  ;(Symbol.metadata ??= Symbol("metadata")), (ie.litPropertyMetadata ??= new WeakMap())
  var x = class extends HTMLElement {
    ...
    static createProperty(e, s = Fe) {
      if (
        ...
        let o = Symbol(),
          r = this.getPropertyDescriptor(e, o, s)
        r !== void 0 && Et(this.prototype, e, r)
      }
    }
    static getPropertyDescriptor(e, s, o) {
      let { get: r, set: l } = Pt(this.prototype, e) ?? {
        get() {
          return this[s]
        },
        set(i) {
      ...
      return {
        ...
        set(i) {
          let a = r?.call(this)
          l.call(this, i), this.requestUpdate(e, a, o)
        },
        configurable: !0,
        enumerable: !0,
      }
    ...
    static finalize() {
      ...
      if (((this.finalized = !0), this._$Ei(), this.hasOwnProperty(V("properties")))) {
        let s = this.properties,
          o = [...zt(s), ...kt(s)]
        for (let r of o) this.createProperty(r, s[r])
      }
      let e = this[Symbol.metadata]
      if (e !== null) {
        let s = litPropertyMetadata.get(e)
        if (s !== void 0) for (let [o, r] of s) this.elementProperties.set(o, r)
      }
      this._$Eh = new Map()
      for (let [s, o] of this.elementProperties) {
        let r = this._$Eu(s, o)
    ...
    _$E_() {
      ...
      for (let o of s.keys()) this.hasOwnProperty(o) && (e.set(o, this[o]), delete this[o])
    ...
    _$EC(e, s) {
      let o = this.constructor.elementProperties.get(e),
        r = this.constructor._$Eu(e, o)
      if (r !== void 0 && o.reflect === !0) {
        let l = (o.converter?.toAttribute !== void 0 ? o.converter : F).toAttribute(s, o.type)
        ;(this._$Em = e),
          l == null ? this.removeAttribute(r) : this.setAttribute(r, l),
          (this._$Em = null)
      }
    }
    _$AK(e, s) {
      ...
      if (r !== void 0 && this._$Em !== r) {
        let l = o.getPropertyOptions(r),
          i =
            typeof l.converter == "function"
              ? { fromAttribute: l.converter }
              : l.converter?.fromAttribute !== void 0
              ? l.converter
              : F
        ;(this._$Em = r), (this[r] = i.fromAttribute(s, l.type)), (this._$Em = null)
      }
    }
    requestUpdate(e, s, o) {
      if (e !== void 0) {
        if (((o ??= this.constructor.getPropertyOptions(e)), !(o.hasChanged ?? ne)(this[e], s)))
          return
        this.P(e, s, o)
      }
    ...
    P(e, s, o) {
      this._$AL.has(e) || this._$AL.set(e, s),
        o.reflect === !0 && this._$Em !== e && (this._$Ej ??= new Set()).add(e)
    }
    async _$ET() {
    ...
    performUpdate() {
      ...
      if (!this.hasUpdated) {
        if (((this.renderRoot ??= this.createRenderRoot()), this._$Ep)) {
          for (let [r, l] of this._$Ep) this[r] = l
          this._$Ep = void 0
        }
        let o = this.constructor.elementProperties
        if (o.size > 0)
          for (let [r, l] of o)
            l.wrapped !== !0 || this._$AL.has(r) || this[r] === void 0 || this.P(r, this[r], l)
      }
      let e = !1,
        s = this._$AL
      try {
        ;(e = this.shouldUpdate(s)),
          e
            ? (this.willUpdate(s), this._$EO?.forEach((o) => o.hostUpdate?.()), this.update(s))
            : this._$EU()
      } catch (o) {
    ...
    update(e) {
      ;(this._$Ej &&= this._$Ej.forEach((s) => this._$EC(s, this[s]))), this._$EU()
    }
    updated(e) {}
    firstUpdated(e) {}
  }
  ;(x.elementStyles = []),
    ...
    Mt?.({ ReactiveElement: x }),
    (ie.reactiveElementVersions ??= []).push("2.0.4")
  var C = class extends x {
    ...
    update(e) {
      ...
      this.hasUpdated || (this.renderOptions.isConnected = this.isConnected),
        super.update(e),
        (this._$Do = j(s, this.renderRoot, this.renderOptions))
    }
    connectedCallback() {
  ...
  ;(C._$litElement$ = !0),
    (C.finalized = !0),
    globalThis.litElementHydrateSupport?.({ LitElement: C })
...
`
  function Ke(t, e) {
    return new Promise((s) => {
      function o(r) {
        r.target === t && (t.removeEventListener(e, o), s())
      }
  ...
  var Ge = (t, e, s) =>
      e in t ? Je(t, e, { enumerable: !0, configurable: !0, writable: !0, value: s }) : (t[e] = s),
    W = (t, e) => {
      for (var s in e || (e = {})) Ut.call(e, s) && Ge(t, s, e[s])
      if (Ze) for (var s of Ze(e)) Ot.call(e, s) && Ge(t, s, e[s])
      return t
    }
  var c = (t, e, s, o) => {
    for (var r = o > 1 ? void 0 : o ? It(e, s) : e, l = t.length - 1, i; l >= 0; l--)
      (i = t[l]) && (r = (o ? i(e, s, r) : i(r)) || r)
  ...
  var be = new Set(),
    ...
    I = new Map(),
    Ye = document.documentElement.dir || "ltr",
    Qe = document.documentElement.lang || navigator.language,
    T
  Nt.observe(document.documentElement, { attributes: !0, attributeFilter: ["dir", "lang"] })
  function K(...t) {
    t.map((e) => {
      let s = e.$code.toLowerCase()
      I.has(s) ? I.set(s, Object.assign(Object.assign({}, I.get(s)), e)) : I.set(s, e), T || (T = e)
    }),
      Xe()
  }
  function Xe() {
  ...
  var ae = class {
    ...
    dir() {
      return `${this.host.dir || Ye}`.toLowerCase()
    }
    lang() {
    ...
    getTranslationData(e) {
      var s, o
      let r = new Intl.Locale(e.replace(/_/g, "-")),
        l = r?.language.toLowerCase(),
        i =
          (o = (s = r?.region) === null || s === void 0 ? void 0 : s.toLowerCase()) !== null &&
          o !== void 0
            ? o
            : "",
        a = I.get(`${l}-${i}`),
        n = I.get(l)
      return { locale: r, language: l, region: i, primary: a, secondary: n }
    }
    exists(e, s) {
      var o
      let { primary: r, secondary: l } = this.getTranslationData(
        (o = s.lang) !== null && o !== void 0 ? o : this.lang()
      )
      return (
        (s = Object.assign({ includeFallback: !1 }, s)),
        !!((r && r[e]) || (l && l[e]) || (s.includeFallback && T && T[e]))
      )
    }
    term(e, ...s) {
      let { primary: o, secondary: r } = this.getTranslationData(this.lang()),
        l
      if (o && o[e]) l = o[e]
      else if (r && r[e]) l = r[e]
      else if (T && T[e]) l = T[e]
  ...
  function rt(t = "") {
    if (!we) {
      let e = [...document.getElementsByTagName("script")],
        s = e.find((o) => o.hasAttribute("data-shoelace"))
      if (s) ot(s.getAttribute("data-shoelace"))
      else {
        let o = e.find(
            (l) =>
              /shoelace(\.min)?\.js($|\?)/.test(l.src) ||
              /shoelace-autoloader(\.min)?\.js($|\?)/.test(l.src)
          ),
          r = ""
        o && (r = o.getAttribute("src")), ot(r.split("/").slice(0, -1).join("/"))
      }
    }
    return we.replace(/\/$/, "") + (t ? `/${t.replace(/^\//, "")}` : "")
  }
  var Dt = { name: "default", resolver: (t) => rt(`assets/icons/${t}.svg`) },
    lt = Dt
  var it = {
      caret: `
...
`
  function S(t, e) {
    let s = W({ waitUntilFirstUpdate: !1 }, e)
    return (o, r) => {
      let { update: l } = o,
      ...
      o.update = function (a) {
        i.forEach((n) => {
          ...
          if (a.has(d)) {
            let m = a.get(d),
              h = this[d]
            m !== h && (!s.waitUntilFirstUpdate || this.hasUpdated) && this[r](m, h)
          }
        }),
          l.call(this, a)
      }
...
`
  var jt = { attribute: !0, type: String, converter: F, reflect: !1, hasChanged: ne },
    qt = (t = jt, e, s) => {
      let { kind: o, metadata: r } = s,
        l = globalThis.litPropertyMetadata.get(r)
      if (
        (l === void 0 && globalThis.litPropertyMetadata.set(r, (l = new Map())),
        l.set(s.name, t),
        o === "accessor")
      ) {
        let { name: i } = s
        return {
          set(a) {
            let n = e.get.call(this)
            e.set.call(this, a), this.requestUpdate(i, n, t)
          },
          init(a) {
      ...
      if (o === "setter") {
        ...
        return function (a) {
          let n = this[i]
          e.call(this, a), this.requestUpdate(i, n, t)
        }
      }
  ...
  function p(t) {
    return (e, s) =>
      typeof s == "object"
        ? qt(t, e, s)
        : ((o, r, l) => {
            let i = r.hasOwnProperty(l)
            return (
              r.constructor.createProperty(l, i ? { ...o, wrapped: !0 } : o),
              i ? Object.getOwnPropertyDescriptor(r, l) : void 0
            )
          })(t, e, s)
  }
  function O(t) {
  ...
  function xe(t, e) {
    return (s, o, r) => {
      let l = (i) => i.renderRoot?.querySelector(t) ?? null
      if (e) {
        let { get: i, set: a } =
          typeof o == "object"
            ? s
        ...
        return M(s, o, {
          get() {
            let n = i.call(this)
            return (
              n === void 0 && ((n = l(this)), (n !== null || this.hasUpdated) && a.call(this, n)), n
            )
          },
        })
      }
  ...
  var y = class extends C {
    ...
    emit(t, e) {
      let s = new CustomEvent(t, W({ bubbles: !0, cancelable: !1, composed: !0, detail: {} }, e))
      return this.dispatchEvent(s), s
    }
    static define(t, e = this, s = {}) {
      let o = customElements.get(t)
      if (!o) {
        customElements.define(t, class extends e {}, s)
        return
      }
      let r = " (unknown version)",
        l = r
      "version" in e && e.version && (r = " v" + e.version),
        "version" in o && o.version && (l = " v" + o.version),
        !(r && l && r === l) &&
          console.warn(
            `Attempted to register <${t}>${r}, but <${t}>${l} has already been registered.`
          )
    }
  }
  y.version = "2.15.0"
  y.dependencies = {}
  c([p()], y.prototype, "dir", 2)
  c([p()], y.prototype, "lang", 2)
  var { I: Ao } = He
  var ut = (t, e) => (e === void 0 ? t?._$litType$ !== void 0 : t?._$litType$ === e)
  var Z = Symbol(),
    ce = Symbol(),
    Se,
    Ae = new Map(),
    b = class extends y {
      ...
      async resolveIcon(t, e) {
        ...
        <use part="use" href="${t}"></use>
          ...
          let r = this.shadowRoot.querySelector("[part='svg']")
          return typeof e.mutator == "function" && e.mutator(r), this.svg
        }
        try {
          if (((o = await fetch(t, { mode: "cors" })), !o.ok)) return o.status === 410 ? Z : ce
        } catch {
          return ce
        }
        try {
          let r = document.createElement("div")
          r.innerHTML = await o.text()
          let l = r.firstElementChild
          if (((s = l?.tagName) == null ? void 0 : s.toLowerCase()) !== "svg") return Z
          Se || (Se = new DOMParser())
          let a = Se.parseFromString(l.outerHTML, "text/html").body.querySelector("svg")
          return a ? (a.part.add("svg"), document.adoptNode(a)) : Z
        } catch {
          return Z
        }
      }
      ...
      disconnectedCallback() {
        super.disconnectedCallback(), ct(this)
      }
      getIconSource() {
        let t = $e(this.library)
        return this.name && t
          ? { url: t.resolver(this.name), fromLibrary: !0 }
      ...
      async setIcon() {
        var t
        let { url: e, fromLibrary: s } = this.getIconSource(),
          o = s ? $e(this.library) : void 0
        if (!e) {
          this.svg = null
          return
        }
        let r = Ae.get(e)
        if ((r || ((r = this.resolveIcon(e, o)), Ae.set(e, r)), !this.initialRender)) return
        let l = await r
        if ((l === ce && Ae.delete(e), e === this.getIconSource().url)) {
          if (ut(l)) {
            this.svg = l
            return
          }
          switch (l) {
            ...
            case Z:
              ...
              break
            default:
              ;(this.svg = l.cloneNode(!0)),
                (t = o?.mutator) == null || t.call(o, this.svg),
                this.emit("sl-load")
          }
        }
      }
  ...
  b.styles = [U, ht]
  c([O()], b.prototype, "svg", 2)
  c([p({ reflect: !0 })], b.prototype, "name", 2)
  c([p()], b.prototype, "src", 2)
  c([p()], b.prototype, "label", 2)
  c([p({ reflect: !0 })], b.prototype, "library", 2)
  c([S("label")], b.prototype, "handleLabelChange", 1)
  c([S(["name", "src", "library"])], b.prototype, "setIcon", 1)
  ...
  var G = mt(
    class extends he {
      constructor(t) {
        if ((super(t), t.type !== pt.ATTRIBUTE || t.name !== "class" || t.strings?.length > 2))
          throw Error(
      ...
      update(t, [e]) {
        if (this.st === void 0) {
          ...
          for (let o in e) e[o] && !this.nt?.has(o) && this.st.add(o)
          return this.render(e)
        }
        let s = t.element.classList
        for (let o of this.st) o in e || (s.remove(o), this.st.delete(o))
        for (let o in e) {
          let r = !!e[o]
          r === this.st.has(o) ||
            this.nt?.has(o) ||
            (r ? (s.add(o), this.st.add(o)) : (s.remove(o), this.st.delete(o)))
        }
        return $
      }
    }
  ...
  function* gt(t, e) {
    if (t !== void 0) {
      let s = 0
      for (let o of t) yield e(o, s++)
    }
  }
  function* ft(t, e, s = 1) {
    let o = e === void 0 ? 0 : t
    e ??= t
    for (let r = o; s > 0 ? r < e : e < r; r += s) yield r
  }
  var Vt = (t, e) => {
      let s = 0
      return function (...o) {
    ...
    vt = (t, e, s) => {
      let o = t[e]
      t[e] = function (...r) {
        o.call(this, ...r), s.call(this, o, ...r)
      }
    },
    Ft = "onscrollend" in window
  if (!Ft) {
    let t = new Set(),
      e = new WeakMap(),
      s = (r) => {
        for (let l of r.changedTouches) t.add(l.identifier)
      },
      o = (r) => {
        for (let l of r.changedTouches) t.delete(l.identifier)
      }
    document.addEventListener("touchstart", s, !0),
      document.addEventListener("touchend", o, !0),
      document.addEventListener("touchcancel", o, !0),
      vt(EventTarget.prototype, "addEventListener", function (r, l) {
        if (l !== "scrollend") return
        let i = Vt(() => {
          t.size ? i() : this.dispatchEvent(new Event("scrollend"))
        }, 100)
        r.call(this, "scroll", i, { passive: !0 }), e.set(this, i)
      }),
      vt(EventTarget.prototype, "removeEventListener", function (r, l) {
        if (l !== "scrollend") return
        let i = e.get(this)
        i && r.call(this, "scroll", i, { passive: !0 })
      })
  }
  var u = class extends y {
    constructor() {
      super(...arguments),
        ...
        (this.scrolling = !1),
        (this.dragging = !1),
        (this.autoplayController = new Be(this, () => this.next())),
        ...
        (this.handleMouseDragEnd = () => {
          ...
          t.style.removeProperty("overflow"),
            ...
            t.scrollTo({ left: e, top: s, behavior: "instant" }),
            requestAnimationFrame(async () => {
              ;(e !== o || s !== r) &&
                (t.scrollTo({ left: o, top: r, behavior: ye() ? "auto" : "smooth" }),
                await Ke(t, "scrollend")),
        ...
        (this.handleSlotChange = (t) => {
          t.some((s) =>
            [...s.addedNodes, ...s.removedNodes].some(
    ...
    getPageCount() {
      let t = this.getSlides().length,
        { slidesPerPage: e, slidesPerMove: s, loop: o } = this,
        r = o ? t / s : (t - e) / s + 1
      return Math.ceil(r)
    }
    getCurrentPage() {
    ...
    handleKeyDown(t) {
      if (["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Home", "End"].includes(t.key)) {
        let e = t.target,
          ...
          o = e.closest('[part~="pagination-item"]') !== null,
          r =
            t.key === "ArrowDown" || (!s && t.key === "ArrowRight") || (s && t.key === "ArrowLeft"),
          l = t.key === "ArrowUp" || (!s && t.key === "ArrowLeft") || (s && t.key === "ArrowRight")
        t.preventDefault(),
          l && this.previous(),
          r && this.next(),
            ...
            this.updateComplete.then(() => {
              ...
              let a =
                (i = this.shadowRoot) == null
                  ? void 0
                  : i.querySelector('[part~="pagination-item--active"]')
              a && a.focus()
            })
      }
    }
    ...
    synchronizeSlides() {
      let t = new IntersectionObserver(
        (e) => {
          ...
          for (let o of e) {
            let r = o.target
            r.toggleAttribute("inert", !o.isIntersecting),
              r.classList.toggle("--in-view", o.isIntersecting),
              r.setAttribute("aria-hidden", o.isIntersecting ? "false" : "true")
          }
          let s = e.find((o) => o.isIntersecting)
          if (s)
            if (this.loop && s.target.hasAttribute("data-clone")) {
              let o = Number(s.target.getAttribute("data-clone"))
              this.goToSlide(o, "instant")
            } else {
              let r = this.getSlides().indexOf(s.target)
    ...
    createClones() {
      let t = this.getSlides(),
        e = this.slidesPerPage,
        s = t.slice(-e),
        o = t.slice(0, e)
      s.reverse().forEach((r, l) => {
        let i = r.cloneNode(!0)
        i.setAttribute("data-clone", String(t.length - l - 1)), this.prepend(i)
      }),
        o.forEach((r, l) => {
          let i = r.cloneNode(!0)
          i.setAttribute("data-clone", String(l)), this.append(i)
        })
    }
    handelSlideChange() {
      let t = this.getSlides()
      t.forEach((e, s) => {
        e.classList.toggle("--is-active", s === this.activeSlide)
      }),
        this.hasUpdated &&
          this.emit("sl-slide-change", {
            detail: { index: this.activeSlide, slide: t[this.activeSlide] },
          })
    }
    updateSlidesSnap() {
      let t = this.getSlides(),
      ...
      t.forEach((s, o) => {
        ;(o + e) % e === 0
          ...
          : s.style.setProperty("scroll-snap-align", "none")
      })
    }
    ...
    goToSlide(t, e = "smooth") {
      let { slidesPerPage: s, loop: o } = this,
        r = this.getSlides(),
        l = this.getSlides({ excludeClones: !1 })
      if (!r.length) return
      let i = o ? (t + r.length) % r.length : ge(t, 0, r.length - 1)
      this.activeSlide = i
      let a = ge(t + (o ? s : 0), 0, l.length - 1),
        n = l[a]
      this.scrollToSlide(n, ye() ? "auto" : e)
    }
    scrollToSlide(t, e = "smooth") {
      let s = this.scrollContainer,
        o = s.getBoundingClientRect(),
        r = t.getBoundingClientRect(),
        l = r.left - o.left,
        i = r.top - o.top
      s.scrollTo({ left: l + s.scrollLeft, top: i + s.scrollTop, behavior: e })
    }
    render() {
      let { slidesPerMove: t, scrolling: e } = this,
        s = this.getPageCount(),
        o = this.getCurrentPage(),
        r = this.canScrollPrev(),
        l = this.canScrollNext(),
              ...
              <div part="navigation" class="carousel__navigation">
                ...
                <button
                  ...
                  class=${G({
                    ...
                    "carousel__navigation-button--disabled": !l,
                  })}
                  ...
                  return f`
                    <button
                      ...
                      class="${G({
                        ...
                        "carousel__pagination-item--active": n,
                      })}"
                      role="tab"
  ...
  u.styles = [U, We]
  u.dependencies = { "sl-icon": b }
  c([p({ type: Boolean, reflect: !0 })], u.prototype, "loop", 2)
  c([p({ type: Boolean, reflect: !0 })], u.prototype, "navigation", 2)
  c([p({ type: Boolean, reflect: !0 })], u.prototype, "pagination", 2)
  c([p({ type: Boolean, reflect: !0 })], u.prototype, "autoplay", 2)
  c([p({ type: Number, attribute: "autoplay-interval" })], u.prototype, "autoplayInterval", 2)
  c([p({ type: Number, attribute: "slides-per-page" })], u.prototype, "slidesPerPage", 2)
  c([p({ type: Number, attribute: "slides-per-move" })], u.prototype, "slidesPerMove", 2)
  c([p()], u.prototype, "orientation", 2)
  c(
  ...
  c([xe(".carousel__slides")], u.prototype, "scrollContainer", 2)
  c([xe(".carousel__pagination")], u.prototype, "paginationContainer", 2)
  c([O()], u.prototype, "activeSlide", 2)
  c([O()], u.prototype, "scrolling", 2)
  c([O()], u.prototype, "dragging", 2)
  c([dt({ passive: !0 })], u.prototype, "handleScroll", 1)
  c(
    [S("loop", { waitUntilFirstUpdate: !0 }), S("slidesPerPage", { waitUntilFirstUpdate: !0 })],
    u.prototype,
    "initializeSlides",
    1
  )
  c([S("activeSlide")], u.prototype, "handelSlideChange", 1)
  c([S("slidesPerMove")], u.prototype, "updateSlidesSnap", 1)
  c([S("autoplay")], u.prototype, "handleAutoplayChange", 1)
...
`
  ...
  $t.replaceSync(bt)
  window.members = Ee
  var wt = "https://cdn.jsdelivr.net/gh/siquu/onering",
    Wt = () => f`<b>You aren't a part of the One Ring (yet).</b>`,
    Kt = (t, e) => f`<div class="one-ring">
  ...
  >
    ${t.map(
      (s) => f`<sl-carousel-item style="position: relative;">
          <img alt=${s.name} src=${wt + `/assets/screenshots/${s.name}.jpg`} />
          <a
            href=${s.url}
  ...
  .one-ring .title img {
    ...
    xt = "https://fonts.googleapis.com/css2?family=Jersey+10&display=swap",
    _t = f`<link rel="preconnect" href="https://fonts.googleapis.com" />
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
  <link href=${xt} rel="stylesheet" />`
  customElements.define(
    "one-ring",
    class extends HTMLElement {
      constructor() {
        document.querySelector(`link[href="${xt}"]`) || j(_t, document.head),
          super().attachShadow({ mode: "open" }),
          (this.shadowRoot.adoptedStyleSheets = [$t])
      }
      connectedCallback() {
        let t = window.members,
          e = t.findIndex((l) => window.location.href.includes(l.url)),
          s = e === -1 ? Wt() : Kt(t, e),
          o = f`${_t}${Zt()}${s}`
        j(o, this.shadowRoot)
        let r = this.shadowRoot.querySelector("sl-carousel")
        setTimeout(() => r?.goToSlide(e, "auto"), 50)
      }
    }
  )
})()
